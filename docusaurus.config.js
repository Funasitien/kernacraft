...
const config = {
  ...
  projectName: 'kernacraft', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/Sans titre 153_20231109161044.png',
      navbar: {
        title: 'KernaCraft',
        logo: {
          alt: 'My Site Logo',
      ...
      footer: {
        ...
        copyright: `Copyright © 2023 - ${new Date().getFullYear()} KernaCraft - DEMOCRAFT STUDIO.`,
      },
      prism: {
